...
| `BOARD.md`, `tickets.json` | generated by `ticket.mjs board` — never committed on `main`; the **settle** workflow publishes them to the `board` branch, which is what Manager reads |
